...
/*!
 * @name Error codes.  Assigned to avoid conflict with EOF and errno(2).
 */
 ...
 *
 * @note Its exposed for API simplicity, I expect parts of it to change!
 */
 ...
 *
 * @warning DO NOT retain pointers to the envp array or any strings
 * contained in it (e.g. to the result of calling FCGX_GetParam),
 * since these will be freed by the next call to FCGX_Finish
 * or FCGX_Accept.
 *
 * @warning DON'T use the FCGX_Request, its structure WILL change.
 */
DLLAPI int FCGX_Accept_r(FCGX_Request *request);

/*!
 * @function FCGX_Finish_r
 *
...
/*!
 * @function FCGX_GetParam obtain value of FCGI parameter in environment
 * @return Value bound to name, NULL if name not present in the
...
/*!
 * @function FCGX_GetChar
 *
 * Reads a byte from the input stream and returns it.
 *
 * @return The byte, or EOF (-1) if the end of input has been reached.
 */
DLLAPI int FCGX_GetChar(FCGX_Stream *stream);

/*!
 * @function FCGX_UnGetChar
 *
 ...
 *
 * @return Returns c if the pushback succeeded, EOF if not.
 */
 ...
 * of the input bytes.
 *
 * @return Number of bytes read.  If result is smaller than n,
 ...
 *
 * @return NULL if EOF is the first thing read from the input stream,
 * str otherwise.
 */
DLLAPI char *FCGX_GetLine(char *str, int n, FCGX_Stream *stream);

/*!
 * @function FCGX_HasSeenEOF
 *
 ...
 *
 * @return EOF if end-of-file has been detected, 0 if not.
 */
...
/*!
 * @function FCGX_PutChar
 *
 * Writes a byte to the output stream.
 *
 * @return The byte, or EOF (-1) if an error occurred.
 */
 ...
 * of the output bytes.
 *
 * @return Number of bytes written (n) for normal return,
 ...
 *
 * @return number of bytes written for normal return,
 * EOF (-1) if an error occurred.
 */
DLLAPI int FCGX_PutS(const char *str, FCGX_Stream *stream);

/*!
 * @function FCGX_FPrintF --
 *
...

/*!
 * @name Both Readers and Writers
 */

/*!
 * @function FCGX_FClose
 *
